                ...
                <div className="buttons text-center mt-[3%] flex justify-center gap-5" >
                    <motion.div ref={ref}
                        ...
                        <Button onClick={()=>{
                            ...
                            showToast("Login to proceed further","➡️",'#262625', 12, "white")
                    ...
                    <motion.div ref={ref}
                        ...
                        <Button onClick={() => {
                            if (token) {
                                showToast("Logout to create new account", "❌", '#262625', 12, "white")
                                return
                            }
