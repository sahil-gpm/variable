            ...
            <motion.div ref={ref}
                ...
                <div className="name text-white text-center mx-auto lg:w-[65%] xl:w-auto font-bold tracking-tight mt-1">
                    I have <span className="name text-white line-through opacity-40">
                        no one
                    </span> <span className='bg-gradient-to-r from-text_start to-text_end text-trans bg-clip-text font-bold tracking-tight'>many friends</span> 🙂 to practice code with.
                </div>
            </motion.div>
