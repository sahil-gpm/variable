    ...
    return (
        <div className={`pt-[6%] h-[100vh] overflow-hidden bg-black`}>
            ...
            <div className='absolute top-10 left-10 bg-black'>
                <Link to={"/"}> <Button text={"⬅ Back"} iconwidth={0} textColor={"white"} width={100} padding={5} borderRadius={20} border={"1px solid white"} /> </Link>
            </div>
            ...
            <motion.div ref={ref}
                ...
                <div className="heading text-center text-white">
                    ...
                    <div className='text-4xl text-center mt-5 font-bold'>
                        <span className='bg-gradient-to-r from-text_start via-text_start to-text_end text-trans bg-clip-text'>Welcome</span> back 💪 !!
                    </div>
                    <div className='w-[40%] mx-auto mt-6 opacity-55'>
                        Variable welcomes you !! ♥️ , hoping you are enjoying coding with with your friends and learning from others 🙂.
                    </div>
                </div>
